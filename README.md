...
```r
install.packages(c("knitr", "rmarkdown", "tidyverse","pheatmap","dendextend"))
```
in the R Console.
...
- QUIZ
- [Practice](https://cecadbioinformaticscorefacility.github.io/Intermediate_R_Course_2026/practice/Session_5_practice.html) 
...
`git clone https://github.com/CECADBioinformaticsCoreFacility/Intermediate_R_Course_2026.git`
